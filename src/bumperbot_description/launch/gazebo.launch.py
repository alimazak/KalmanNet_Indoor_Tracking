...
def generate_launch_description():
    ...
    # GUI plugins (Plot3D vb.)
    gz_gui_plugin_path = SetEnvironmentVariable(
        name="GZ_GUI_PLUGIN_PATH",
        value="/opt/ros/jazzy/opt/gz_sim_vendor/lib/gz-sim-8/plugins/gui"
    )

    # Your saved layout with 2x Plot3D
    gui_config = "/home/tuyildiz/KalmanNet_Indoor_Tracking/gui/paper_trails_gui.config"
    ...
    gazebo = IncludeLaunchDescription(
        ...
        launch_arguments={
            # gz sim <world> -v 4 -r --gui-config <file>
    ...
    gz_ros2_bridge = Node(
        ...
        arguments=[
            ...
            "/world/empty_world/set_pose@ros_gz_interfaces/srv/SetEntityPose"
        ],
